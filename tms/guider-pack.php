...
$status=0;
$sql="INSERT INTO tblgbooking(PackageId,UserEmail,FromDate,ToDate,Comment,status) VALUES(:pid,:useremail,:fromdate,:todate,:comment,:status)";
...
<?php 
$pid=intval($_GET['pkgid']);
$sql = "SELECT * from guider where id=:pid";
$query = $dbh->prepare($sql);
$query -> bindParam(':pid', $pid, PDO::PARAM_STR);
$query->execute();
...
<form name="book" method="post">
		<div class="selectroom_top">
			...
			<div class="col-md-8 selectroom_right wow fadeInRight animated" data-wow-delay=".5s">
				...
				<p><b>Guider Age :</b> <?php echo htmlentities($result->age);?></p>
				<p><b>Guider City :</b> <?php echo htmlentities($result->city);?></p>
