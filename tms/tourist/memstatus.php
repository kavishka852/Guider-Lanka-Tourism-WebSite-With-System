...
<html>
<head>
<title>TMS | Admin Manage Members</title>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>Manage Packages</h2>
						...
						<tbody>
<?php $sql = "SELECT tblusers.id as id,tblusers.FullName as fname,tblusers.MobileNumber as mnumber,tblusers.EmailId as email,tblusers.RegDate as RegDate from  tblusers ";
...
<td width="50"><div class='text-center'><?php if( $row['status'] == 'Active' ){ echo '<i class="fas fa-circle" style="color:green;"></i> Active';} else if ($row['status'] == 'Expired') { echo '<i class="fas fa-circle" style="color:red;"></i> Expired';} else { echo '<i class="fas fa-circle" style="color:orange;"></i> Pending Reg';}?></div></td>
						  </tr>
						 <?php $cnt=$cnt+1;} }?>
						</tbody>
					  </table>
