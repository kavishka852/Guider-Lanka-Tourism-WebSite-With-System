...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Reminder</li>
...
<!--End-Action boxes-->    
    ...
    <?php
      ...
      include "dbcon.php";
      $qry="SELECT tblusers  WHERE reminder='".$_SESSION['reminder']."'";
      $cnt = 1;
        $result=mysqli_query($con,$qry);
            ...
            while($row=mysqli_fetch_array($result)){ ?>
              ...
              <?php if($row['reminder'] == '1') { ?>
                ...
                <hr>
                <p class="mb-0">We value you as our customer and look forward to continue serving you in the future. Thank you!</p>
              </div>
