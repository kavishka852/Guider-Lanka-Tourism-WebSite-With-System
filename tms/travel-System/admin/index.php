      ...
      <div class="widget-box">
        ...
        <div class="widget-content" >
          <div class="row-fluid">
            ...
            <div class="span4">
              <ul class="site-stats">
                <li class="bg_ly"><i class="fas fa-users"></i> <strong><?php include 'dashboard-usercount.php';?></strong> <small>Total Members</small></li>
                ...
                <li class="bg_ls"><i class="fas fa-user-ninja"></i> <strong><?php include 'actions/count-trainers.php';?></strong> <small>Active Gym Trainers</small></li>
                <li class="bg_lr"><i class="fas fa-dumbbell"></i> <strong><?php include 'actions/count-equipments.php';?></strong> <small>Available Equipments</small></li>
                <li class="bg_lh"><i class="fas fa-file-invoice-dollar"></i> <strong>Rs.<?php include 'actions/total-exp.php';?></strong> <small>Total Expenses</small></li>
