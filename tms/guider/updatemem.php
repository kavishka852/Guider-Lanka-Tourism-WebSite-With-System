...
$sql="update tblusers set FullName=:fname,MobileNumber=:mobilenumber,EmailId=:email,Password=:password where id=:id";
...
<html>
<head>
<title>TMS | Admin Update Member</title>
...
{	?>
					...
					<form class="form-horizontal" name="package" method="post" enctype="multipart/form-data">
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="fname" id="fname" placeholder="Create Name" required="">
									</div>
								</div>
<div class="form-group">
									<label for="focusedinput" class="col-sm-2 control-label">Mobile number</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" name="mobilenumber" id="mobilenumber" placeholder="Give MobileNo" required="">
									</div>
								</div>
