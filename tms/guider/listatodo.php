				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>All Announcements</h2>
						...
						<tbody>
<?php $sql = "SELECT todo.id as id,todo.Task-status as tsk,todo.task_desc as dsc from  todo ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>		
						  <tr>
							...
							<td width="50"><?php echo htmlentities($result->tsk);?></td>

						        <td width="50"><?php echo htmlentities($result->dsc);?></td>
