...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>To do list</li>
            </ol>
<div class="agile-grids">	
				...
				<div class="agile-tables">
					...
					<table id="table">
						...
						<tbody>
<?php $sql = "SELECT todo.id as id,todo.task_status as ts,todo.task_desc as td,todo.name as nm from todo ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>		
						  <tr>
							...
							<td width="50"><?php echo htmlentities($result->ts);?></td>

						        <td width="50"><?php echo htmlentities($result->td);?></td>
					<td width="50"><?php echo htmlentities($result->nm);?></td>
					
                                        <td width="50"><a href="includes/remove-todo.php?id=<?php echo htmlentities($result->id);?>" onclick="return confirm('Do you really done todo?')" >Done</a></td>	
