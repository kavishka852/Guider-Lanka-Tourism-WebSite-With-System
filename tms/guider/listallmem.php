...
<html>
<head>
<title>TMS | Admin Announcement</title>
				...
				<div class="agile-tables">
					<div class="w3l-table-info">
					  <h2>All Announcements</h2>
						...
						<tbody>
<?php $sql = "SELECT announcements.id as id,announcements.message as msg,announcements.date as dte from  announcements ";
$query = $dbh -> prepare($sql);
$query->execute();
...
{				?>		
						  <tr>
							...
							<td width="50"><?php echo htmlentities($result->msg);?></td>

						        <td width="50"><?php echo htmlentities($result->dte);?></td>
